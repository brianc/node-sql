...
var valueExpressionMixin = require(__dirname + '/node/valueExpression');
...
//append arbitrary extra text to a column
Column.prototype.appendText = function(text) {
  var context = contextify(this);
  context.extraText = text;
  return new ColumnNode(context);
}
